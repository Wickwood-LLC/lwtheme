 ...
 * @ingroup themeable
 */
function lwtheme_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function lwtheme_feed_icon($url) {
 ...
 */
function lwtheme_comment_wrapper($content, $type = null) {
  static $node_type;
