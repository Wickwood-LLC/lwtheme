...
function lwtheme_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function lwtheme_feed_icon($url, $title) {
 ...
 */
function lwtheme_preprocess_comment_wrapper(&$vars) {
 ...
 */
function lwtheme_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function lwtheme_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function lwtheme_button($element) {
...
*/
function lwtheme_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function lwtheme_node_preview($node) {
