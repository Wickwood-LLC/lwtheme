...
<div id="art-page-background-middle-texture">
    ...
    <div class="cleared reset-box"></div>
    	...
    	<div class="art-box-body art-sheet-body">
				...
				<div class="cleared reset-box"></div>
				<?php if (!empty($navigation) || !empty($extra1)): ?>
							...
							?>
											<div class="art-footer-text">
													...
													if (!empty($footer) && (trim($footer) != '')) {
															...
															ob_start(); ?>
															<p>Copyright © <?php echo ( date("Y") <= 2012 ? "2012" : "2012-".date("Y")); ?> Lawrence S Wittner, All Rights Reserved.</p>
															<p><a href="/privacy-policy">Privacy Policy</a> • <a href="/terms-of-use">Website Terms of Use</a> • <a href="/contact">Contact Us</a>
