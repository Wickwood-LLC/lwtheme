...
function lwtheme_process_html(&$variables) {
...
function lwtheme_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function lwtheme_button($variables) {
 ...
 */
function lwtheme_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function lwtheme_menu_local_task($variables) {
 ...
 */
function lwtheme_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function lwtheme_node_preview($variables) {
  $node = $variables['node'];
